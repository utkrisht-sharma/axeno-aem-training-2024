$(document).ready(function() {
    $('.home-loan-form').submit(function(event) {
        ...
        // Append the specific path for the JSON endpoint
        const urlPath = `${currentPath}/jcr:content/root/container/container/homeloan.json`;

        // Send an AJAX request to submit the form data
        $.ajax({
            url: urlPath, // Use the dynamically constructed URL
            type: 'POST',
