...
public class SearchServiceImpl implements SearchService {
     ...
     * @return a {@link Pair} containing a list of found paths and the total number of matches.
     ...
     */
    @Override
    public Pair<List<String>, Long> executePageSearch(ResourceResolver resolver, String searchPath, String propOne, String propOneVal, String propTwo, String propTwoVal) throws LoginException, RepositoryException {
        ...
        return Pair.of(foundPaths, matchCount);
    }

    /**
     * Builds a query map for performing the search.
     * The query map includes search path, property filters, and date range.
     *
     * @param searchPath the path where the search should be performed.
     * @param propOne the name of the first property to filter on.
     * @param propOneVal the value of the first property to filter on.
     * @param propTwo the name of the second property to filter on.
     * @param propTwoVal the value of the second property to filter on.
     * @return a map of query parameters for the search.
     */
